...
private void habilitaJogador1(){
    ...
    this.jogador2 = false;
    this.marcacao = "X";
    jLStatus.setText("Aguardando jogador 'X'...");
}
...
private void habilitaJogador2(){
    ...
    this.jogador2 = true;
    this.marcacao = "O";
    jLStatus.setText("Aguardando jogador 'O'...");
}
...
private void ganhou(int ganhador){
    desabilitaCampos();
    if(ganhador == 1){
        jLStatus.setText("O jogador n° 'X' venceu!");
    }
    else{
        jLStatus.setText("O jogador n° 'O' venceu!");
    }
}
